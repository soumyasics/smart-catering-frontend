      ...
      <div class="container-fluid d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
          <ul>
            ...
            <li>
              <Link class="nav-link scrollto" to="/cusprofile">
                Profile
              </Link>
            </li>
            <li>
              <Link to="/Service" class="nav-link scrollto">
                Services
              </Link>
            </li>
            <li>
              <Link to="/ViewOrders" class="nav-link scrollto">
                View my Orders
              </Link>
            </li>
            <li>
              <Link to="/CusComplaints" class="nav-link scrollto">
                View my Complaints
              </Link>
            </li>
